...
public static class Localizer
{
    private static readonly Dictionary<string, (string Fa, string En)> Strings = new()
    {
        ...
        ["CategoryHotkey"] = ("میانبر بازکردن این دسته", "Hotkey for this category"),
        ["CategoryHotkeyHint"] = ("روی کادر کلیک کنید و میانبر را بزنید؛ Backspace برای حذف", "Click the box and press a shortcut; Backspace to remove"),
        ...
        ["CategoryHotkeyError"] = ("یک یا چند میانبر دسته معتبر نیست یا توسط برنامهٔ دیگری استفاده می‌شود.", "One or more category hotkeys are invalid or already in use."),
